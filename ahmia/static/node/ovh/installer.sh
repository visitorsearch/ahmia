...
wget https://www.visitorfi5kl7q7i.onion/IP/ -O IP.txt
wget https://www.visitorfi5kl7q7i.onion/static/node/our_exit_policy -O /etc/tor/torrc
wget https://www.visitorfi5kl7q7i.onion/static/node/tor-exit-notice.html -O /etc/tor/tor-exit-notice.html
